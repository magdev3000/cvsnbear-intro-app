          ...
          { this.state.active ? (
            <div className="ColorPickerInput-block">
              ...
              <div className="ColorPickerInput-default">
                {theme_colors && theme_colors.length ? <div className="ColorPickerInput-default-title">{I18n.t('Store Colors')}</div> : null}
                ...
                <div className="ColorPickerInput-default-title">{I18n.t('Recommended Colors')}</div>
                <div className="ColorPickerInput-default-items">
                ...
                {hideGradient ? null : <div className="ColorPickerInput-default-title">{I18n.t('Gradients')}</div> }
                {hideGradient ? null : (
                  <div className="ColorPickerInput-default-items">
